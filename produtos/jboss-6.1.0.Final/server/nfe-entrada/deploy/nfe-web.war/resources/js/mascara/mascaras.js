...
/*Função que restringe caracteres não permitidos em endereços de e-mail*/
function Destinatario(v) {
...
/* Função que permite apenas letras, números e o ponto (.) */
function LetraNumeroPonto(v){
	v = v.replace(/[^A-Za-z0-9.]/g, "");
	return v;
}

/* Função que permite apenas letras, números, ponto (.) e o underline (_) */
function LetraNumeroPontoUnderline(v){
